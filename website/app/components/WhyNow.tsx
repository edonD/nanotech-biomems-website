    ...
    <section id="whynow" className="relative section-padding overflow-hidden" ref={ref}>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-red-500/30 via-accent-cyan/30 to-accent-green/30" />
          ...
          {timeline.map((item, i) => (
            ...
            >
              ...
              <div className={`flex-1 ml-16 md:ml-0 ${i % 2 === 0 ? "md:text-right md:pr-16" : "md:text-left md:pl-16"}`}>
                ...
                <h3 className="text-lg md:text-xl font-semibold text-white/85 mb-2">
                  {item.title}
                </h3>
              ...
              {/* Dot */}
              <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-3 h-3 rounded-full border-2 border-[#030712]">
                <div className={`w-full h-full rounded-full ${item.dotColor} ${i === timeline.length - 1 ? "animate-pulse" : ""}`} />
              </div>
